...
DEFAULT_PRODUCTS = [
    ...
    },
    {
        ...
        'compareAt': 2990,
        'category': 'T-Shirts',
        'description': 'A substantial premium-cotton crew neck with a clean collar, relaxed shoulder and polished drape.',
        'imageUrl': '/static/images/atelier-ivory-tee.png',
        'badge': 'New',
        'sizes': ['S', 'M', 'L', 'XL', 'XXL'],
        'stock': 28,
        'rating': 4.8,
    ...
    {
        '_id': 'signature-10',
        'name': 'Midnight Relaxed Tee',
        'price': 2690,
        'compareAt': 0,
        'category': 'T-Shirts',
        'description': 'A softly structured black T-shirt in dense combed cotton, cut with an easy contemporary fit.',
        'imageUrl': '/static/images/midnight-tee.png',
        'badge': 'Essential',
        'sizes': ['S', 'M', 'L', 'XL', 'XXL'],
        'stock': 35,
        'rating': 4.7,
    },
    {
        ...
        'compareAt': 3790,
        'category': 'Shirts',
        'description': 'A pale-blue cotton Oxford with a soft button-down collar and an effortless, refined shape.',
        'imageUrl': '/static/images/sky-oxford-shirt.png',
        'badge': 'New colour',
        'sizes': ['S', 'M', 'L', 'XL', 'XXL'],
        'stock': 22,
        'rating': 4.9,
    ...
    {
        '_id': 'signature-12',
        'name': 'Savile Pleated Trouser',
        'price': 4790,
        'compareAt': 5490,
        'category': 'Trousers',
        'description': 'A charcoal single-pleat trouser with an extended waistband, clean taper and elegant full-length line.',
        'imageUrl': '/static/images/savile-trouser.png',
        'badge': 'Editor\'s pick',
